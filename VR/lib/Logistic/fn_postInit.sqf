...
[
    {format[localize "STR_GECO_JK_LOADIN", getText(configFile >> "CfgVehicles" >> typeof cursorTarget >> "displayName")]},
...
[
    {format[localize "STR_GECO_JK_LOADOUT",getText(configFile >> "CfgVehicles" >> typeOf (cursorTarget getVariable ["JK_Loadedin",[ObjNull]] select 0) >> "displayName"),getText(configFile >> "CfgVehicles" >> typeof cursorTarget >> "displayName")]},
    ["AllVehicles"],
    10,
