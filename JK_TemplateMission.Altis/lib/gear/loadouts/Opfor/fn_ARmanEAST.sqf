...
//clothing - (string)
_uniforms = ["U_B_CombatUniform_mcam_tshirt","U_B_CombatUniform_mcam_tshirt","U_B_CombatUniform_mcam_vest","U_B_CombatUniform_mcam"];
_vests = ["V_PlateCarrierSpec_rgr","V_PlateCarrierGL_rgr"];
...
_primaryweapon = "arifle_MX_SW_F";

//primary weapon items - (array)
_itemsPrimaryweapon = ["optic_MRCO","acc_pointer_IR"];
