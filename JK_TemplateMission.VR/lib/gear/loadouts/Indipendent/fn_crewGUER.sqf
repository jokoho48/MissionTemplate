...
//clothing - (string)
_uniforms = ["U_I_CombatUniform_shortsleeve","U_I_CombatUniform"];
_vests = ["V_BandollierB_cbr","V_BandollierB_rgr","V_BandollierB_khk","V_BandollierB_oli","V_BandollierB_blk"];
_headgears = ["H_HelmetCrew_I"];
_backpacks = [""];
_insignium = "Curator";
...
_primaryweapon = "arifle_Mk20_plain_F";
