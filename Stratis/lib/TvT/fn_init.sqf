...
_fnc_createTaskArray = {
    _taskParameter = [];
    {
        _pushbackParams = [_x,(format["TakeBase&1%2",_x,_count]), (format[localize "STR_GECO_TVT_TAKEBASESHORT",_count]),(format[localize "STR_GECO_TVT_TAKEBASELONG",_x,_count]),"DESTROY",(format["marker%1", _count])];
...

{
    _count = _count + 1;
    [
        (format [localize "STR_GECO_TVT_TAKEPOINT", _count]),
        _x,
        5,
